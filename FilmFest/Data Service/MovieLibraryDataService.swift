...
enum LibrarySection: Int {
    case MoviesToWatch, MoviesAlreadyWatched
}
class MovieLibraryDataService: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        switch librarySection {
            case .MoviesToWatch:
                return movieManager.moviesToWatchCount
            case .MoviesAlreadyWatched:
                return movieManager.moviesWatchedCount
        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if librarySection == .MoviesToWatch {
    ...
    func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        ...
        let sectionTitle = librarySection.rawValue == 0 ? "Movies To Watch" : "Movies Already Watched"
